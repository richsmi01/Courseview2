...
echo '<ul>';
echo '    <li>';
echo "<input type='checkbox' class='cv_collapsible' id ='cv_check1'  $cv_check/>";
echo "       <label for='cv_check1' >CourseView Administration</label>";
echo "       <div>";
echo"          <ul>";
...
echo "<li class='sub'>";
echo "   <input type='checkbox' id='cv_check4' class = 'cv_collapsible' $cv_check/>";
echo"    <label for='cv_check4' >Manage Courses and Cohorts</label>";
echo"   <div class='sub'>";
echo"        <input type='checkbox' id='cv_check5' class = 'cv_collapsible' />";
echo"       <label for='cv_check5' >Add a Course</label>";
